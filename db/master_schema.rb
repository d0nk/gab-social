...
ActiveRecord::Schema.define(version: 2021_01_23_050026) do
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.index ["created_at", "reply", "reblog_of_id", "account_id", "group_id"], name: "index_statuses_on_created_at_desc_account", order: { created_at: :desc }
    t.index ["created_at", "reply", "reblog_of_id"], name: "index_statuses_on_created_at_desc_account_id", order: { created_at: :desc }
    t.index ["created_at"], name: "index_statuses_on_created_at"
    t.index ["group_id", "reply", "reblog_of_id", "account_id"], name: "index_statuses_group_id_reply"
